            ...
            <div className="flex-1 space-y-5.5 custom-scrollbar overflow-y-auto pr-1 pb-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-200/60 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-1.5 text-[11px] text-zinc-850 dark:text-zinc-200 placeholder-zinc-400 dark:placeholder-zinc-650 outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all"
                />
              </div>
