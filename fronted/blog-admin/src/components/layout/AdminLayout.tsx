...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex h-screen w-screen overflow-hidden bg-zinc-50 dark:bg-zinc-950 bg-noise-texture transition-colors">
      {/* ===== 背景柔光游走气泡 (仅浸染底色，高颜值) ===== */}
      ...
      {/* 主工作区域 (py-3 pr-3，配合 Sidebar 的 m-3 mr-0，形成完美 12px 悬空边距) */}
      <div className="relative z-10 flex flex-1 flex-col overflow-hidden gap-3 py-3 pr-3">
        {/* 顶部栏 */}
        <TopBar />
